        ...
        <form action="" method="POST" >
            ...
            <div class="row flex flex-wrap">
                <div class="p-5 w-4/12">
                    ...
                    <select  class="rounded-full border border-gray-200 w-full px-5  focus:outline-none h-9 text-sm" name="experience" id="">
                ...
                <div class="p-5 w-4/12">
                    ...
                    <select class="rounded-full border border-gray-200 w-full px-5  focus:outline-none h-9 text-sm" name="hiring" id="">
