...
<div class="w-10/12 mx-auto text-gray-700">
    <div class="w-8/12">
        ...
        <div class="flex  justify-start my-2">
            ...
            <p class="text-xs mx-1">{{$enterprise->city->name}}</p>
        </div>
        <div class="flex  justify-start my-2">
            ...
            <p class="text-xs mx-1">{{$enterprise->employees}}</p>
        </div>
        <div class="flex  justify-start my-2">
            ...
            <p class="text-xs mx-1">{{$enterprise->sector}}</p>
        </div>
    </div>

    <div class="content">
        <h1 class="text-2xl font-medium py-5 text-main-blue">Vacantes <span class="font-semibold">disponibles</span></h1>
