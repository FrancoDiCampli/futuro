    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @recruiter
                <div class="hidden space-x-28 sm:-my-px sm:ml-10 sm:flex">
                    {{-- @if(user()->profile->premiun_active) --}}
                    ...
                    <x-slot name="trigger">
                        ...
                        <button class="flex items-center text-sm font-medium text-gray-500 transition duration-150 ease-in-out hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300">
                            <div class="flex items-center justify-between">
                                @if(isset(user()->profile->avatar->path) )
                                    <img class="h-12 rounded-full shadow-sm" src="{{asset('storage/'.user()->profile->avatar->path) }}" alt="user">
                                @else
