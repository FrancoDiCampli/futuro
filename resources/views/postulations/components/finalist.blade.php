...
<div class="card bg-white p-5 flex justify-start items-start my-5 border">
    ...
    <div class="text-left mx-5 text-sm">
        ...
        <div class="flex my-5">
            <p>{{$postulation->student->subcategory->name}}</p>
        ...
        <a class="text-xl text-main-blue my-2" href="{{route('get.postulation',['student'=>$postulation->student->id,'vacancy'=>$vacancy->id])}}">{{$postulation->student->title}}</a>
