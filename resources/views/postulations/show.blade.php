...
<div class="w-10/12 mx-auto text-gray-700">
    ...
    <img class="h-24 rounded-full shadow-md my-5" src="{{asset('assets/001 - Home/foto-eduardo.png')}}" alt="">
    ...
    <div class="flex  justify-start items-center my-2">
        ...
        <p class="text-xs mx-1">{{$postulation->student->birthdate->format('d M Y')}}</p>
    </div>
    <div class="flex  justify-start items-center my-2">
        ...
        <p class="text-xs mx-1">{{$postulation->student->city->name}}</p>
    </div>
    ...
    <div class="flex  justify-start items-center my-2">
        ...
        <p class="text-xs mx-1">{{$postulation->student->experience}}</p>
    </div>
    <div>
        <h1 class="font-semibold text-2xl my-10" >{{$postulation->student->title}}</h1>
    </div>
