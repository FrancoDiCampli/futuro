            ...
            <div class="card bg-white p-5 mb-10 flex justify-between items-start">
                ...
                <div class="w-8/12 mx-5">
                    ...
                    <div class="flex items-center  my-2 text-sm">
                        ...
                        <p class="mx-2">Ciudad de México, México</p>
                    </div>
                    <div class="flex items-center  my-2 text-sm">
                    ...
                    <div class="flex items-center  my-2 text-sm">
                        ...
                        <p class="mx-2">reclutador@mail.com</p>
                    </div>
                </div>

                <a href="#" class="bg-main-blue text-gray-100 px-5 py-2 rounded-full">
                    Aceptar
                </a>
