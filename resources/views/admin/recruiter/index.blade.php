...
<div class="w-10/12 mx-auto">
    <h1 class="text-center text-xxl text-main-blue md:text-left md:text-4xl ">Vacantes <span class="font-semibold">activas</span> </h1>
    ...
    <div class="container flex mt-10 text-gray-600">
        <div class="w-8/12 content">
            ...
            <div class="p-5 mb-10 bg-white card">
                <div class="flex items-center justify-between mt-5 row">
                    <div class="flex items-center ">
                        {{-- <a href="{{route('vacancies.show',$vacancy)}}" class="text-lg font-semibold text-main-blue">{{$vacancy->title}}</a> --}}
                        <a href="{{route('postulation.index',$vacancy->id)}}" class="text-lg font-semibold text-main-blue">{{$vacancy->title}}</a>
                       <p class="px-5 py-1 mx-5 text-sm text-white rounded-full bg-lime">Abiertas</p>
                    </div>
                ...
                <p class="my-5 text-xl font-semibold">{{count($vacancy->students)}} <span class="font-normal">Aplicantes</span> </p>
                ...
                <div class="flex items-start justify-between mt-5">
                    <div class="text-main-blue">
                        ...
                        <div class="flex items-center">
                            ...
                            <p class="mx-2 text-xl font-semibold text-gray-700">{{$vacancy->news}}</p>
                        </div>
                    </div>
                    ...
                    <div class="text-main-blue">
                        ...
                        <div class="flex items-center">
                            ...
                            <p class="mx-2 text-xl font-semibold text-gray-700">{{$vacancy->rejected}}</p>
                        </div>
                    </div>
                    ...
                    <div class="text-main-blue">
                        ...
                        <div class="flex items-center">
                            ...
                            <p class="mx-2 text-xl font-semibold text-gray-700">{{$vacancy->final}}</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="w-4/12 aside ">
            @if(user()->profile->belong_enterprise == 1)
            <div class="items-center p-5 mx-5 mb-10 text-center bg-white card">
                <div class="pt-2 logo">
                    <img class="h-16 mx-auto" src="img/logos/danone.png" alt="">
                </div>
                <div class="my-5">
                    <h1 class="font-semibold text-center">{{user()->profile->enterprise->name}}</h1>
                    <div class="flex justify-center my-5">
                        ...
                        <p class="mx-1 text-xs">empleados {{user()->profile->enterprise->employees}}</p>
                    </div>
                    <div class="flex justify-center my-5">
                        ...
                        <p class="mx-1 text-xs">{{user()->profile->enterprise->sector}}</p>
                    </div>
                </div>


                <div class="flex items-center justify-center w-8/12 px-5 py-2 mx-auto my-5 text-white rounded-full bg-lime">
                   <p class="px-1 mx-2 text-gray-700 bg-white rounded-full ">{{count(enterprise()->vacancies)}}</p><p class="font-semibold">Vacantes</p>
                </div>
             ...
             @else
                    <p>No posee empresa</p>
                @endif
            <a href="{{route('jobs.create')}}" class="flex items-center justify-center w-10/12 py-2 m-5 mx-auto text-center text-white rounded-full bg-main-blue">
