...
<div class="w-10/12 mx-auto">
    <h1 class="text-xxl text-main-blue text-center md:text-left md:text-4xl ">Encuentra <span class="font-semibold">talento</span> </h1>
    ...
    <div class="content flex flex-wrap">
        ...
        <a href="{{route('students.show',$student->id)}}" class="card w-56 bg-white space-x-2 mx-1 text-gray-700 justify-center mt-5 cursor-pointer">
            ...
            <div class="my-5">
                ...
                <h1 class="text-center font-semibold">{{$student->first_name}}</h1>
            ...
            <div class="my-5 mx-auto text-center">
                <h2 class="text-xl text-main-blue font-semibold">{{$student->title}}</h2>
