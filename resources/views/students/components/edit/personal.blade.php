...
<div class="row flex flex-wrap">
    <div class="px-10 py-5 w-6/12">
        ...
        <input class="rounded-full border border-gray-200 text-base w-full px-5 @error('birthdate') border-red-500 @enderror" type="date" name="birthdate" id="birthdate" value="{{ $student->birthdate }}">
...
<div class="row flex flex-wrap">
    ...
    <div class="px-10 py-5 w-6/12 ">
        <img src="{{asset('assets/001 - Home/foto-mauricio.png')}}" alt="" class="h-24 mx-auto">
        <label
