...
<div class="w-10/12 mx-auto text-gray-700">
    ...
    <div class="flex items-center  my-5 text-sm">
        ...
        <p class="mx-2">{{$job->city->name}}, {{$job->city->state->name}}</p>
    </div>
    <h2 class="text-2xl font-bold">${{$job->pretended}}</h2>
    ...
    <div class="container flex">
            ...
            <div class="paragraph p-5 ">
                ...
                <div class="flex flex-wrap text-xs">
                    ...
                    <div class="flex items-start w-4/12 my-5">
                        ...
                        <div>
                            <p>Contratation</p>
                            <p class="font-semibold">{{$job->hiring}}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start w-4/12 my-5">
                        ...
                        <div>
                            <p>Disponibilidad</p>
                            <p class="font-semibold">{{$job->available}}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start w-4/12 my-5">
                        ...
                        <div>
                            <p>Horario</p>
                            <p class="font-semibold">{{$job->schedule}}</p>
                        </div>
                    </div>
        ...
        <div class="aside w-4/12 ">
            ...
            <div class="flex items-center w-10/12 mx-auto justify-center text-center bg-main-blue text-white m-5 rounded-full py-2">
                <p>Postularme</p>
